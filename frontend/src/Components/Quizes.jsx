...
import { Divider,Container, Grid, Card, CardContent, Typography, CardMedia, Box } from '@mui/material';
      ...
      <Grid container spacing={7}>
        {cardsData.map((card) => (
          <Grid item xs={12} sm={8} md={4} key={card.id}>
            <Card sx={{ width: '100%', height: 250, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <CardMedia
                component="img"
